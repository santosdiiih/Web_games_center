...
const CardPost = ({ post }) => {
    ...
    // Verificar se a imagem não è vazia 
    const verificarImg = () => {
        var elemento = document.getElementById('imgPublicacao');
        if (post.imagem_video === "") {
            elemento.current.style.display = "none";
        }
    }
    ...
    return (
        <div className="container-publicacao">
            <div className="top-side-publicao">
                ...
                <div><p className="text-dark texto-horario">Publicado {post.createdAt}</p></div>
            ...
            <div className="Imagem-publicacao mb-4" onChange={verificarImg}>
...
const NovaPostagem = ({ carregarPostagem }) => {
    ...
    const enviar = async (e) => {
        ...
        data.append("titulo", novaPostagem.tiulo);
            ...
            <form onSubmit={enviar}>
                <div className="container-pergunta">
                    <div className="pergunta-top-side">
                        <div>
                            <img src={Perfil} className="FotoPublicao" alt="Sua foto de perfil" />
                        </div>
                        <div>
                            <input
                                id="titulo"
                    ...
                    <div className="pergunta-buttom-side">
                        <div className="area-imagem-pergunta text-white ml-3 mt-3">
                            ...
                            <div className="container-imagem mb-0">
                                <img alt="preview" className="Imagem-Container" ref={imgRef} />
                            </div>
                        </div>
